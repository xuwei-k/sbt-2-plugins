...
addSbtPlugin("com.disneystreaming.smithy4s" % "smithy4s-sbt-codegen" % "0.19.0-RC1")
...
addSbtPlugin("com.github.sbt" % "sbt-maven-plugin" % "0.0.3")
addSbtPlugin("com.github.sbt" % "sbt-mocha" % "2.2.0-M2")
...
addSbtPlugin("com.softwaremill.sttp.tapir" % "sbt-openapi-codegen" % "1.13.15")
...
addSbtPlugin("io.github.sbt-dao-generator" % "sbt-dao-generator" % "2.1.0")
...
addSbtPlugin("org.playframework" % "play-docs-sbt-plugin" % "3.1.0-M8")
addSbtPlugin("org.playframework" % "sbt-play-ebean" % "9.0.0-M2")
addSbtPlugin("org.playframework" % "sbt-plugin" % "3.1.0-M8")
addSbtPlugin("org.playframework" % "sbt-scripted-tools" % "3.1.0-M8")
