...
addSbtPlugin("com.github.sbt" % "sbt-java-formatter" % "0.11.1-M2")
...
addSbtPlugin("com.softwaremill.sttp.tapir" % "sbt-openapi-codegen" % "1.13.16")
...
addSbtPlugin("org.jetbrains.scala" % "sbt-structure-extractor" % "2026.1.4")
