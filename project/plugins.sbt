...
addSbtPlugin("com.jamesward" % "sbt-reload" % "0.0.5")
...
addSbtPlugin("io.github.mercurievv" % "sbt-scalasemantic-mcp" % "0.3.5")
...
addSbtPlugin("io.github.scalauser12" % "sbt-release-io-monorepo" % "0.13.4")
...
addSbtPlugin("org.jetbrains.scala" % "sbt-structure-extractor" % "2026.2.5")
...
addSbtPlugin("org.webjars" % "sbt-webjars" % "0.0.8")
addSbtPlugin("org.wvlet.uni" % "sbt-uni" % "2026.1.13")
