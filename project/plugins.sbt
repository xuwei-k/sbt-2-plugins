addSbtPlugin("africa.shuwari" % "sbt-snx" % "0.1.0")
...
addSbtPlugin("com.evolution" % "sbt-kagi-plugin" % "0.1.0")
...
addSbtPlugin("com.github.xuwei-k" % "proto-unused-imports" % "0.1.3")
...
addSbtPlugin("com.github.xuwei-k" % "sbt-shapeless-generic-counter" % "0.1.2")
...
addSbtPlugin("com.github.xuwei-k" % "unused-proto-plugin" % "0.2.2")
...
addSbtPlugin("com.indoorvivants" % "sbt-revolver" % "0.11.1")
addSbtPlugin("com.indoorvivants" % "sbt-revolver-core" % "0.11.1")
addSbtPlugin("com.indoorvivants" % "sbt-revolver-native" % "0.11.1")
...
addSbtPlugin("com.softwaremill.sttp.tapir" % "sbt-openapi-codegen" % "1.13.19")
...
addSbtPlugin("io.github.sbt-teavm" % "sbt-teavm" % "0.5.0")
...
addSbtPlugin("me.seroperson" % "sbt-testkit-plugin" % "0.1.0")
...
addSbtPlugin("org.scalameta" % "sbt-munit" % "1.3.2")
...
addSbtPlugin("org.wvlet.uni" % "sbt-uni" % "2026.1.11")
