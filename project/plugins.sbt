...
addSbtPlugin("com.github.xuwei-k" % "warning-diff-scalafix-plugin" % "0.6.5")
...
addSbtPlugin("com.softwaremill.sttp.tapir" % "sbt-openapi-codegen" % "1.13.14")
...
addSbtPlugin("org.scalameta" % "sbt-native-image" % "0.4.0-M1")
