...
addSbtPlugin("com.softwaremill.sttp.tapir" % "sbt-openapi-codegen" % "1.13.17")
...
addSbtPlugin("io.github.scalauser12" % "sbt-release-io" % "0.12.0")
...
addSbtPlugin("org.wvlet.uni" % "sbt-uni" % "2026.1.3")
